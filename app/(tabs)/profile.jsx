    ...
    return(
        ...
        <View className="flex-1 items-center bg-background"> 
            ...
            <View className="w-full items-center -mt-20">
                {/* Name and username */} 
                <Text 
                    className="text-2xl text-ivory font-wsbold mt-8">
                    Lorem Ipsum
                </Text>
                <Text 
                    className="text-xl text-ivory font-wsbold mt-1">
                    @lorem_123
                </Text>
                ...
                <View className="w-full h-full items-center bg-indigo rounded-3xl py-10 mt-6">
